...
*
*****************************************************************************/
void fill_distance_matrix(cell_type *cell,long num_atoms,float *dist_mat,
			  point_type *vect)
{
  long num_so_far;
  point_type temp;
  ...
  detail_type *details;
{
  ...
  ******/
  write(matfile,(const char *)&(cell->dim),sizeof(long));
  write(matfile,(const char *)&(num_atoms),sizeof(long));
