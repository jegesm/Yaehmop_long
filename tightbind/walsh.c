...
*
*****************************************************************************/
void walsh_update(cell_type *cell,detail_type *details,long step,char printing)
{
  ...
  long i;
  long num_atoms,num_vars,which_var,num_steps;
  real *values;
  atom_type *atom;
  ...
  if( printing ){
    ...
    /****
      ...
      prlong out some status information which will be used to generate the actual
      Walsh diagrams
  ...
  long step;
{
  ...
  /**********
    ...
    of the program then prlong out header information that tells what each of the
  ...
  ***********/
  ...
  /*******************
    now actually prlong out the results that are desired
  ********************/

  /* prlong out the values of the Walsh variables */
  for(i=0;i<details->walsh_details.num_vars;i++){
