 ...
 ***/
   ...
   long *orbital_lookup_table;
 {
   ...
   static long last_overlap=-1;
   long i,ii,j,itab,jtab;
   real accum,accumI,temp,temp2;
   real answer, answer_contrib,Hii_1, Hii_2;
   long begin1,begin2,end1,end2;
   long found1,found2,offset1,offset2;
   long orbital_sum,increment,set1,set2;
   long *FMO_map1,*FMO_map2,frag_1,frag_2,fmo_index1,fmo_index2;
   long which_overlap;
   ...
   *********/
   ...
   case P_DOS_FMO:
     ...
     FMO_map1 = calloc(details->FMO_frags[frag_1].num_orbs,sizeof(long));
     ...
     if(frag_1 == frag_2){
       ...
       FMO_map2 = calloc(details->FMO_frags[frag_2].num_orbs,sizeof(long));
       increment=0;
  ...
  *    weighting factor for the K polong of the orbitals.
  *  
   ...
   long *orbital_lookup_table;
 {
   ...
   *******/
   ...
   while(COOP_ptr1){
     ...
     /* prlong out the contributions to this COOP */
