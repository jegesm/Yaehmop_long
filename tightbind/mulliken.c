...
{
  long i,begin_degen,end_degen,num_degen_levels,last_occup;
...
void reduced_mulliken(num_atoms,num_orbs,orbital_lookup_table,OP_matrix,ROP_matrix)
  long num_atoms,num_orbs,*orbital_lookup_table;
  real *OP_matrix;
  real *ROP_matrix;
{
  long i,j,k,l;
  long ktab;
  long i_orb_tab, j_orb_tab;
  long i_orb_end,j_orb_end;
  long num_elements;
  real temp;
...
void FMO_reduced_mulliken(details,num_atoms,num_orbs,OP_matrix,ROP_matrix)
  detail_type *details;
  long num_atoms,num_orbs;
  real *OP_matrix;
  real *ROP_matrix;
{
  FMO_frag_type *FMO_frag1,*FMO_frag2;
  long frag1,frag2;
  long orbs_so_far1,orbs_so_far2;
  long i,j,k,l;
  long ktab;
  long i_orb_tab, j_orb_tab;
  long i_orb_end,j_orb_end;
  ...
  real *occupations,*OP_matrix,*accum,*net_chgs;
{
  ...
  long i,j,k;
  long itab,jtab,ktab;
  long begin_of_atom,end_of_atom;
