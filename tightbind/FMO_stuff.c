  ...
  long *orbital_lookup_table;
{
  ...
  long FMO_begin1,FMO_end1,FMO_begin2,FMO_end2;
  long frag,atom1,atom2;
  long num_frags;
  ...
  long *orbital_lookup_table;
{
  ...
  long frag,atom1,atom2,i,j,k;
  long itab,FMO_itab;
  long jtab,FMO_jtab;
  long ktab,FMO_ktab;
  long begin1,end1,FMO_begin1,FMO_end1;
