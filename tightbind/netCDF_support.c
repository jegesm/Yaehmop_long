...
{long errval; errval=__fcall__;netCDF_handle_error(errval);}

void netCDF_handle_error(long status)
{
  char errstring[240];
		      ...
		      long walsh_step)
{
  ...
  char outname[240];
  long fileid;
  long dim_array[10],count_array[10];
  long symb_var_ID,pos_var_ID,param_var_ID;
  long kpoints_ID,kpoint_weights_ID,num_electrons_ID;
  long lattice_ID;
