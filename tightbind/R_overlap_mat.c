...
*
****************************************************************************/
void zero_overlaps(real *overlap,detail_type *details,long num_orbs,long num_atoms,
		   char doing_unit_cell,long *orbital_lookup_table)
{
  long i,j,k;
...
void R_space_overlap_matrix(cell,details,overlap,num_orbs,tot_overlaps,
  ...
  long num_orbs,tot_overlaps;
  long *orbital_lookup_table;
  long which_one;
{
  char err_string[240];
  long overlaps_so_far;
  long i,j,k;
  long itab,jtab,ktab;
  long overlap_tab;
