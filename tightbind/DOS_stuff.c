...
real atom_contribution(num_orbs,num_atoms,kpoint,MO,avg_prop_info,which_atom,
  ...
  long num_orbs,num_atoms,kpoint,MO;
  avg_prop_info_type *avg_prop_info;
  long which_atom,*orbital_lookup_table;
{
  long i,atom_begin,atom_end;
  float *chg_mat_ptr;
  long AO;
  real contrib;
...
{
  long i,j,k,l;
  long tot_num_orbs,num_states,begin,end;
  real num_at_this_E;
  real diff;
  real accum;
  real this_E;
